package com.jnf.wechat.service.impl;
...
import com.jnf.wechat.mapper.MenuMapper;
import com.jnf.wechat.service.MenuService;
...
public class MenuServiceImpl extends ServiceImpl<MenuMapper, Menu> implements MenuService {
    ...
    public List<MenuVo> findMenuInfo() {
        ...
        for (Menu oneMenu : oneMenuList) {
            ...
            if (oneMenu != null) BeanUtils.copyProperties(oneMenu,oneMenuVo);

            //4.获取每个一级菜单里面所有二级菜单 id 和 parent_id比较
            //一级菜单id  和 其他菜单 parent_id
            ...
            for (Menu twoMenu : twoMenuList) {
                ...
                if (twoMenu != null) BeanUtils.copyProperties(twoMenu,twoMenuVo);

                children.add(twoMenuVo);
            }
            oneMenuVo.setChildren(children);

            //每个封装好的一级菜单放到最终list集合
            list.add(oneMenuVo);
        }
